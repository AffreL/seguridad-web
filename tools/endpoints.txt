...
def layout(title: str, body: str, user: Optional[sqlite3.Row] = None, status_code: int = 200) -> HTMLResponse:
...
def admin(
    ...
    if not user["is_admin"]:
        return layout("Admin", '<section class="card"><p>No tenes permisos de administrador.</p></section>', user, status_code=403)
